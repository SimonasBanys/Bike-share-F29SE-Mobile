...
<h1>Maps: Density of finishStation for rides</h1>
...
<table style="border: 1px solid black; width: 100%;">
    ...
    <tr>
        <th>Station ID</th>
        <th>Number of Bikes Ending at that Station</th>
    </tr>

    <?php
    $query = "SELECT endStationID, COUNT(*) AS `Number of Bikes` FROM `FinishedRides` GROUP BY endStationID";
    ...
    foreach ($rows as $row){
        ?>
        <tr>
            <td><?php echo $row['endStationID']; ?></td>
